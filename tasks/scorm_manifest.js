...
module.exports = function (grunt) {
    ...
    grunt.registerMultiTask('scorm_manifest', 'Generate a valid SCORM IMS manifest file.', function () {
        ...
        var xmlTokens = {
            ...
            fileArr: options.modules.map(function (module, i) {
                return [
                    {
                        'resource': [
                            {'@identifier': 'resource_' + (i + 1)},
                            {'@type': 'webcontent'},
                            {'@href': module.launchPage}
                        ]
                    }
                ]
            })
        ...
        (function () {
            ...
            xmlTokens.fileArr.forEach(function (resource) {
                resource.push(tObj);
            });
        })();
        ...
        var xmlObj = {
            manifest: {
                ...
                resources: xmlTokens.fileArr
            },
        };

        options.modules.forEach(function (module, i) {
            xmlObj.manifest.organizations.organization.push({
                item: {
                    '@identifier': 'item_' + (i + 1),
                    '@identifierref': 'resource_' + (i + 1),
